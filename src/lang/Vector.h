...
static lisp_VectorArray* lisp_VectorArray_constructor(lisp_VectorArray*, lisp_Value**);
...
static lisp_Value* lisp_Vector_from_mut_list(lisp_State*, lisp_MutList*);
static lisp_Value* lisp_Vector_from_list(lisp_State*, lisp_List*);
static lisp_Value* lisp_Vector_internal_new(lisp_State*);
static lisp_Value* lisp_Vector_clone(lisp_State*, lisp_Vector*);
...
static lisp_Value* lisp_Vector_get(lisp_State*, lisp_Vector*, lisp_u64);

static lisp_VectorNode* lisp_Vector_new_path_set(lisp_State*, lisp_VectorNode*, lisp_u64, lisp_u64, lisp_Value*, lisp_u64);
static lisp_Value* lisp_Vector_set(lisp_State*, lisp_Vector*, lisp_u64, lisp_Value*);
...
static void lisp_Vector_push_value(lisp_State*, lisp_Vector*, lisp_Value*);
static void lisp_Vector_push_mut_list(lisp_State*, lisp_Vector*, lisp_MutList*);

static lisp_Value* lisp_Vector_push(lisp_State*, lisp_Vector*, lisp_Value*);

static lisp_Value* lisp_Vector_to_string(lisp_State*, lisp_Vector*);
