...
lisp_Object* lisp_List_set(lisp_State* state, lisp_Object* list, uintsize index, lisp_Object* object);
static void lisp_List_mut_set(lisp_State* state, lisp_Object* list, uintsize index, lisp_Object* object);

lisp_Object* lisp_List_push(lisp_State* state, lisp_Object* list, lisp_Object* object);
static void lisp_List_mut_push(lisp_State* state, lisp_Object* list, lisp_Object* object);

lisp_Object* lisp_List_unshift(lisp_State* state, lisp_Object* list, lisp_Object* object);
